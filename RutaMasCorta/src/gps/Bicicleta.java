...
public class Bicicleta {
    ...
    public static String rutaCorta(int [] camino1, int [] camino2, int [] camino3)
    {
        ...
        sum1 = sumaTramos(camino1.length, camino1);
        sum2 = sumaTramos(camino2.length,camino2);
        sum3 = sumaTramos(camino3.length,camino3);
    ...
    public static int sumaTramos(int longitud,int [] camino) {
    	int suma = 0;
